...
Exp=$(curl -sS https://raw.githubusercontent.com/wayangkulit95/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
Exp1=$(curl https://raw.githubusercontent.com/wayangkulit95/permission/main/ipmini | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
export sem=$( curl -s https://raw.githubusercontent.com/wayangkulit95/permission/main/versions)
...
clear
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}" | lolcat
echo -e " ${z}│$NC\033[41m       Welcome To Script Premium MICROTECH.STORE          $NC${z}│$NC"
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}" | lolcat
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}" | lolcat
...
echo -e " ${z}│                                                          $NC${z}│$NC"
echo -e " ${z}│$NC [${r}25${NC}]${CYAN} UPDATE SCRIPT$NC ${KANAN} \E[0m\033[0;34m                                  $NC${z}│$NC"
...
echo -e " ${z}│${NC}${z}Script Status $blue=${NC} ( ${green}Active${NC} ) ${NC}"
if [ $exp \< 1000 ];
then
...
25) clear ; wget https://raw.githubusercontent.com/wayangkulit95/kelangkabot/main/up.sh && chmod +x up.sh && ./up.sh ;;
99) clear ; up ;;
0) clear ; menu ;;
00) exit ;;
