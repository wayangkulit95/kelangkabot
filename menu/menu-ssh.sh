...
data_ip="https://raw.githubusercontent.com/wayangkulit95/permission/main/ipmini"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/artamaeribo"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/60136369200"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
echo -e "  ${ORANGE}[6].${NC}\033[0;36m Padam SSH & OpenVpn Account ${NC}"
echo -e "  ${ORANGE}[7].${NC}\033[0;36m Padam User Expired SSH & OpenVPN ${NC}"
